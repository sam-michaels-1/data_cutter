        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-xs text-gray-500 uppercase tracking-wide border-b border-gray-200">
              ...
              <th className="sticky top-0 z-10 hidden sm:table-cell text-right py-2 pr-4 bg-white">Change</th>
              <th className="sticky top-0 z-10 hidden sm:table-cell text-right py-2 pr-4 bg-white">% of Total</th>
              <th className="sticky top-0 z-10 text-center py-2 pr-4 w-16 bg-white">Trend</th>
              <th className="sticky top-0 z-10 text-center py-2 bg-white">Status</th>
            </tr>
          </thead>
          <tbody>
            {customers.map((c) => {
